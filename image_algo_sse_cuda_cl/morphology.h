...
//
//EXPORT_IMAGE_ALGO_DLL void morphologyEx(Image& src, Image& dst, int op, Image& kernel,
//	int iter, int bordertype, std::vector<int> bordervalue);
//
//EXPORT_IMAGE_ALGO_DLL void erode(Image& src, Image& dst, Image& kernel,
//	int iterations, int borderType, std::vector<int> scalar);
//
//EXPORT_IMAGE_ALGO_DLL void dilate(Image& src, Image& dst, Image& kernel,
//	int iterations, int borderType, std::vector<int> scalar);
//
